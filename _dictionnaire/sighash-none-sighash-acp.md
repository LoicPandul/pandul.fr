...
letter: "S"
layout: definition
description: "Type de SigHash Flag (0x82) combiné avec le modificateur SIGHASH_ANYONECANPAY (SIGHASH_ACP) utilisé dans les signatures des transactions Bitcoin."
