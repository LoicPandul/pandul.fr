...
permalink: /dictionnaire/sweep-transaction/
...
![Sweep transaction : un seul UTXO de 50 000 sats en entrée et un unique output de 49 000 sats, signature d'un auto-transfert.](/assets/img/dictionnaire/sweep-transaction/image-1.png)