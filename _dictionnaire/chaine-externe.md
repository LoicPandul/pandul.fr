...
letter: "C"
layout: definition
description: "Dans la dérivation des portefeuilles déterministes et hiérarchiques, la chaîne externe est une branche de dérivation utilisée pour générer des adresses..."
...
![Arbre BIP-84 avec flèche pointant sur le niveau Chaînes, où chaque compte se divise en chaîne externe /0 et interne /1.](/assets/img/dictionnaire/chaine-externe/image-1.png)
