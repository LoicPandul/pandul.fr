...
![Réutilisation interne : l'adresse bc1q...xyz figure à la fois en input et en output, ce qui révèle l'output de change.](/assets/img/dictionnaire/reutilisation-d-adresse-int/image-1.png)