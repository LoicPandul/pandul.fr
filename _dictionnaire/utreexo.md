...
![Preuve d'inclusion Utreexo : avec l'UTXO 3, HASH 4 et HASH 1-2, le nœud reconstitue la racine de Merkle qu'il stocke en RAM.](/assets/img/dictionnaire/utreexo/image-1.png)
