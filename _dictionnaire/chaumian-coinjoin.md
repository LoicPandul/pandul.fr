...
permalink: /dictionnaire/chaumian-coinjoin/
...
![Séquence d'un coinjoin chaumien : envoi de l'input et d'un output masqué, signature aveugle, démasquage anonyme via Tor.](/assets/img/dictionnaire/chaumian-coinjoin/image-1.png)
