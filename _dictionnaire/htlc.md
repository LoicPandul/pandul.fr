...
* David présente une *invoice* Lightning à Alice. Celle-ci contient le hachage $$h$$ d'un secret $$s$$ (la préimage) que seul David connait. On a donc : $$h\ =\ hachage(s)$$ ;
